...
@interface CourseCreateDescriptionView()
...
@implementation CourseCreateDescriptionView
...
-(void)setupTopLabel
{
    ...
    [_myTopLabel setText:@"Введите описание курса"];
...
-(void)makeConstraints
{
    ...
    NSLayoutConstraint *textFieldHeight = [_myTextField.heightAnchor constraintEqualToConstant:160.0f];
...
{
    NSDictionary *data = [NSDictionary dictionaryWithObject:_myTextField.text forKey:@"courseDescription"];
